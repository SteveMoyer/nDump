...
namespace CsvInserter
{
    public class DataTransformer
    {
        ...
        public DataTransformer(string sqlScriptDirectory, string sourceDirectory, ConsoleLogger logger, ICsvToSqlInsertConverter csvToSqlInsertConverter)
        {
        ...
        public DataTransformer(string sqlScriptDirectory, string sourceDirectory, ConsoleLogger logger):this(sqlScriptDirectory,sourceDirectory,logger, new CsvToSqlInsertConverter(5000))
        {
        }
